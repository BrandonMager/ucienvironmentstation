...
function AldrichDetails({
    ...
    return(
        ...
        <div className="text-white text-l text-center my-5">
            <h1 className="text-2xl font-medium">Aldrich Hall Air Quality</h1>
            <hr className = "my-2" />
